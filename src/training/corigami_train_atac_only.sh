...
cd /gpfs1/tangfuchou_pkuhpc/tangfuchou_test/lujiansen/software/corigami

python train_atac_only.py \
    --data-root corigami_data/data \
    --assembly hg38 \
    --celltype gm12878 \
    --save_path GM12878_ATAC_ONLY \
    --num-gpu 1 \
    --batch-size 4 \
    --num-workers 2 \
    --ddp-disabled &> GM12878_ATAC_ONLY_training.log
